...
Png5.Free;
//выставл€ем кол.потронов.
N:=7;
//выставл€ем кол. очков.
A:=0;
//делаем так чтобы патроны и очки отображались на экране.
Label1.Caption:=IntToStr(N);
Label2.Caption:=IntToStr(A);
//выставл€ем левую утю.
Image2.Left :=-130;
Image2.Top:=490;
 //выставл€ем правую утю.
Image3.Left :=930;
Image3.Top:=490;
//делаем так чтобы ут€ не мерцалв при полЄте.
 Form1.DoubleBuffered:= true;
end;
...
begin
//таймер который следит за выигрешем и проигрешем.
if (N <= 0)  then
begin
...
Timer6.Enabled := true;
 ...
 ShowMessage('»гра окончена');
end;
end;

procedure TForm1.Timer6Timer(Sender: TObject);
begin
//тайме который управл€ет псом с 1 утей.
  Image6.Visible:=true;
